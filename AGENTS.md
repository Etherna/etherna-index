...
- There is a single OpenAPI document, `index03`, filtered to the marker via `MetadataFilterDocumentTransformer<IndexApiMarker>`, served to Swagger UI (with OAuth2 against SSO). Transformers live in `Configs/OpenApi/`.
