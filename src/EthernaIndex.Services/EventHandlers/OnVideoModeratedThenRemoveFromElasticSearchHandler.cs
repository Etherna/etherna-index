...
{
    internal sealed class OnVideoModeratedThenRemoveFromElasticSearchHandler : EventHandlerBase<VideoModeratedEvent>
    {
        // Fields.
        ...
        {
            await elasticSearchService.DeleteVideoAsync(@event.Video);
        }
    }
}
